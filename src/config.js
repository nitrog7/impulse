System.config({
  ...
  map: {
    ...
    "falcor-http-datasource": "github:Netflix/falcor-http-datasource@0.1.2",
    "falcor-json-graph": "github:Netflix/falcor-json-graph@1.1.7",
    "falcor-path-syntax": "github:Netflix/falcor-path-syntax@0.2.4",
    "falcor-path-utils": "github:Netflix/falcor-path-utils@0.3.4",
